...
from utils.viseme_polly import polly_phonemes_to_visemes
from utils.viseme_disney import phonemes_to_disney_visemes
from utils.viseme_ms import phonemes_to_ms_visemes
...
def text_to_visemes(
    ...
    if mode == LipMode.POLLY:
        visemes = polly_phonemes_to_visemes(phonemes)
    elif mode == LipMode.DISNEY:
        visemes = phonemes_to_disney_visemes(phonemes)
    elif mode == LipMode.MS_ID:
        visemes = phonemes_to_ms_visemes(phonemes)
...
def get_phoneme_viseme(
    text: str,
    mode: LipMode = LipMode.MS_ID,
